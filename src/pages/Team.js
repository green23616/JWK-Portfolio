...
function Team() {
  ...
  return (
    <div className="container 2xl:top-48 mx-auto max-w-[650px] lg:max-w-[1200px] h-[652px] relative lg:flex lg:gap-x-6">
      ...
      <CloneBox title="맛있으면 0칼로리 (개인)" skill="Next.js" skill2="typescript" skill3="styled" left2="-left-[18px]" left4="-left-[7px]" skill4="mysql" contribution="100" worktime="2" imgurl="7" detail="DB에 데이터를 저장하고" detail2="먹은 음식을 입력하면 칼로리와 영양정보를" detail3="제공하는 반응형 웹" vercel="JWK-Portfolio" git="green23616" imgurl2="b"/>
    </div>
  )
}
