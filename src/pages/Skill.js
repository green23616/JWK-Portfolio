      ...
      <div className="absolute top-[-60px] 2xl:top-[-110px] left-[32.5%]">
        ...
        <div className="border basis-[31%] md:basis-1/3 h-[31%] md:h-full mb-4 md:mb-0">
          ...
          <div className="flex w-full flex-wrap justify-start">
            <MobileBox iconw="w-16" num3="p-16" ttop="top-24" basis="basis-1/2" skill="Next.js" color="bg-green-500" num="bottom-3" num2="left-[67px]"/>
            ...
            <MobileBox iconw="w-16" num3="p-16" ttop="top-24" basis="basis-1/2" skill="typescript" color="bg-blue-500" num="bottom-5" num2="left-[49px]"/>
            <MobileBox iconw="w-16" num3="p-14" ttop="top-24" basis="basis-1/2" skill="tailwindcss" color="bg-green-500" num="bottom-4" num2="left-[43px]"/>
        ...
        <div className="border basis-[31%] md:basis-1/3 h-[31%] md:h-full mb-4 md:mb-0">
          <div className="text-left">
            ...
            <div className="flex w-full flex-wrap justify-start">
              <MobileBox iconw="w-16" basis="basis-1/2" skill="mongodb" color="bg-green-500" ttop="top-24" num3="p-16" num="bottom-8" num2="left-[58px]"/>
              <MobileBox iconw="w-16" basis="basis-1/2" skill="node.js" color="bg-green-500" ttop="top-20" num3="p-16" num="bottom-5" num2="left-[65px]"/>
              <MobileBox iconw="w-18" basis="basis-1/2" skill="mysql" color="bg-blue-500" ttop="top-20" num3="p-12" num="bottom-6" num2="left-[62px]"/>
      ...
      <div className="container mx-auto max-w-[697px] relative gap-x-6">
        <div className="border mb-4 w-full">
          ...
          <div className="flex w-full flex-wrap justify-start">
            ...
            <MobileBox iconw="w-12" ttop="top-4" num3="pb-8" basis="basis-1/3" skill="styled" color="bg-green-500" num="bottom-2" num2="left-[86px]"/>
          </div>
        </div>
        <div className="border h-[31%] mb-4 pb-4">
          <div className="text-left">
            ...
            <div className="flex w-full flex-wrap justify-start">
              <MobileBox iconw="w-12" num3="pb-8" basis="basis-1/3" skill="mongodb" ttop="top-4" color="bg-green-500" num="bottom-2" num2="left-[72px]"/>
              <MobileBox iconw="w-12" basis="basis-1/3" skill="node.js" color="bg-green-500" ttop="top-4" num3="pb-8" num="bottom-2" num2="left-[87px]"/>
              <MobileBox iconw="w-12" num3="pb-8" basis="basis-1/3" skill="mysql" ttop="top-4" color="bg-blue-500" num="bottom-2" num2="left-[81px]"/>
        ...
        <div className="border h-[31%] mb-4 pb-4">
          <div className="text-left">
            ...
            <div className="flex w-full flex-wrap justify-start">
              ...
              <MobileBox iconw="w-12" num3="pb-8" basis="basis-1/3" skill="slack" ttop="top-4" color="bg-blue-500" num="bottom-2" num2="left-[91px]"/>
            </div>
          </div>
        </div>
