...
function Contact() {
  ...
  return (
    ...
    <div className="container 2xl:top-48 mx-auto max-w-[650px] lg:max-w-[1200px] h-[652px] relative lg:flex lg:gap-x-6">
      ...
      <div className="div">
        <CloneBox title="추사기념관 (진행중)" skill="react" skill2="tailwindcss" skill3="Javascript" left2="-left-[20px]" left3="-left-[14px]" skill4="figma" contribution="100" worktime="1" detail="클론 코딩" imgurl="3" vercel="react-chusa" git="green23616/React-Chusa" imgurl2="f"/>
      </div>
    </div>
    </>
  )
