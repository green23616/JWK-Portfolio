import { faUsers, faDesktop, faBookOpen } from '@fortawesome/free-solid-svg-icons';
...
function Work() {
  ...
  return (
    ...
    <div className="container 2xl:top-48 mx-auto max-w-[697px] md:max-w-[1200px] h-[665px] md:h-[652px] relative md:flex gap-x-6 cursor-pointer">
      ...
      <div className="border basis-[31%] md:basis-1/3 h-[31%] md:h-full mb-4 md:mb-0 hover:scale-105 transition-all duration-200" onClick={()=>navigate('/work/toy')}>
      <div className="h-1/3 md:h-full text-center text-4xl cursor-pointer">
          <p className='-translate-x-[8%] md:translate-x-0 translate-y-[220%] md:translate-y-[820%]' style={{fontFamily:"GmarketSansBold"}}>
            Examples
          </p>
          <FontAwesomeIcon icon={faBookOpen} size='xl md:2xl' className='mt-11 md:mt-20 ml-48 md:ml-0'></FontAwesomeIcon>
        </div>
      </div>
    </div>
    }
    <Outlet/>
      <div className="navv hidden md:block absolute text-base xl:text-base top-[109px] 2xl:top-[606px] left-[55%] 2xl:left-[168px]">
